...
<div class="wrapper">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2 class="bg-success w-100 text-center p-2 rounded mt-2">Designation List</h2>
                <div class="row mt-3">
                    <div class="col-md-2">
                        <a href="#" class="btn btn-outline-success mb-2" data-toggle="modal" data-target="#addDesignation">ADD Designation</a>
                    </div>
                ...
                @if(session()->has('addDesignationSuccess'))
                <div class="alert alert-success">
                    {{session()->get('addDesignationSuccess')}}
                </div>
                @endif
                <hr>
                <div class="row">
                ...
                <!-- Modal -->
                <div class="modal fade" id="addDesignation" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                            ...
                            <form action="{{url('/designation')}}" method="post">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" id="designationName" class="form-control @error('name') is-invalid @enderror" required>
                                        <span class="text-danger text-size-sm" id="errorDesignation" style="display: none;">
...
<script>
    ...
    function myFun(key) {
        // e.preventDefault();
        // var show = false;
        let id = document.querySelectorAll(".dsetting");
